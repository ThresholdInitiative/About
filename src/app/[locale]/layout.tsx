...
export default async function LocaleLayout({
  ...
  // Resolve the params promise to get the locale
...
export default function LocaleLayout({
  ...
  // Note: We don't validate locale here as it's done in the page component
  // to avoid double validation and potential issues with params being promises
  
  return (
    <html lang={locale}>
      <head>
        {/* Server-side rendered Schema for SEO */}
        <ServerSchema locale={locale} isAboutPage={false} />
